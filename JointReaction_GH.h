#ifndef _JointReaction_GH_h_
#define _JointReaction_GH_h_
/* -------------------------------------------------------------------------- *
 *                         OpenSim:  JointReaction_GH.h                          *
 * -------------------------------------------------------------------------- *
 ...
 * @version 1.0
 */
class OSIMPLUGIN_API JointReaction_GH : public Analysis {
OpenSim_DECLARE_CONCRETE_OBJECT(JointReaction_GH, Analysis);
...
protected:
	...
	*   joints specified in _jointNames*/
	...
	/** Internal work array for holding the JointReaction_GHKeys to identify the 
	*   desired joints, onBody, and inFrame to be output*/
	Array<JointReaction_GHKey> _reactionList;
...
public:
	...
	// CONSTRUCTION
	//-------------------------------------------------------------------------
	JointReaction_GH(Model *aModel=0);
	JointReaction_GH(const std::string &aFileName);
	JointReaction_GH(const JointReaction_GH &aObject);
	virtual ~JointReaction_GH();
...
public:
#ifndef SWIG
	JointReaction_GH& operator=(const JointReaction_GH &aJointReaction_GH);
#endif
...
//=============================================================================
}; // END of class JointReaction_GH
}; //namespace
//=============================================================================
//=============================================================================

#endif // #ifndef __JointReaction_GH_h__
